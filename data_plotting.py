...
for i, d in enumerate(max_distances):
    ...
    for t in thresholds:
        trivial, max_spread = parse_pred_file('../analysis_data/predictions-02-11-2055/mate-1-' + str(d) + '-' + str(t) + '.csv')
...
for i, d in enumerate(max_distances):
    non_trivial_percentages.append([])
    for t in thresholds:
        trivial, max_spread = parse_pred_file('../analysis_data/predictions-02-11-2055/mate-2-' + str(d) + '-' + str(t) + '.csv')
        non_trivial_percentages[i].append(1 - trivial)
...
for i, d in enumerate(max_distances):
    non_trivial_percentages.append([])
    for t in thresholds:
        trivial, max_spread = parse_pred_file('predictions/mate-1-' + str(d) + '-' + str(t) + '.csv')
        non_trivial_percentages[i].append(1 - trivial)
...
for i, d in enumerate(max_distances):
    non_trivial_percentages.append([])
    for t in thresholds:
        trivial, max_spread = parse_pred_file('predictions/mate-2-' + str(d) + '-' + str(t) + '.csv')
        non_trivial_percentages[i].append(1 - trivial)
